	...
	function ccjc(a,b){
		var t_a=(sp[0].offsetLeft==sp[1].offsetLeft)&&(a.offsetTop==b.offsetTop);
		var t_b=(sp[0].offsetTop==sp[1].offsetTop)&&(a.offsetLeft==b.offsetLeft);
		if(t_a||t_b){
			if(t_a){
...
function gyjc(a,b){
	var t_a=(sp[0].offsetTop==sp[1].offsetTop)&&(a.offsetLeft==b.offsetLeft);
